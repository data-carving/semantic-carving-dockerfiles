...
dict_IMERG_all = {}
dict_IMERG = {}
IMERG_hf = h5py.File('/shared/hdf5_selections/POMD/IMERG-PF/level2/202002.h5.carved','r')
...
for dataset in dataset_names:
    if dataset in datasets_to_include:
        dict_IMERG_all[dataset] = IMERG_hf[dataset][()]

for dataset in dataset_names:
    if dataset in datasets_to_include:
        dict_IMERG[dataset] = IMERG_hf[dataset][
        (dict_IMERG_all['LON'] > -85.0) & (dict_IMERG_all['LON'] < -30.0) & (dict_IMERG_all['LAT'] > -60.0) & (dict_IMERG_all['LAT'] < 15.0) & (
                    dict_IMERG_all['RAINAREA'] > 2000.0) & (dict_IMERG_all['RAINAREA_5'] > 100.0)]
...
dict_GEOS5_all = {}
dict_GEOS5 = {}
GEOS5_hf = h5py.File('/shared/hdf5_selections/POMD/GEOS5-PF/level2/202002.h5.carved','r')
...
for dataset in dataset_names:
    if dataset in datasets_to_include:
        dict_GEOS5_all[dataset] = GEOS5_hf[dataset][()]

for dataset in dataset_names:
    if dataset in datasets_to_include:
        dict_GEOS5[dataset] = GEOS5_hf[dataset][
        (dict_GEOS5_all['LON'] > -85.0) & (dict_GEOS5_all['LON'] < -30.0) & (dict_GEOS5_all['LAT'] > -60.0) & (dict_GEOS5_all['LAT'] < 15.0) & (
                    dict_GEOS5_all['RAINAREA'] > 2000.0) & (dict_GEOS5_all['RAINAREA_5'] > 100.0)]
...
df_IMERG_SA_ST = df_IMERG.loc[
    (df_IMERG['LON'] > -85.0) & (df_IMERG['LON'] < -30.0) & (df_IMERG['LAT'] > -60.0) & (df_IMERG['LAT'] < 15.0) & (
                df_IMERG['RAINAREA'] > 2000.0) & (df_IMERG['RAINAREA_5'] > 100.0)]
df_GEOS5_SA_ST = df_GEOS5.loc[
    (df_GEOS5['LON'] > -85.0) & (df_GEOS5['LON'] < -30.0) & (df_GEOS5['LAT'] > -60.0) & (df_GEOS5['LAT'] < 15.0) & (
                df_GEOS5['RAINAREA'] > 2000.0) & (df_GEOS5['RAINAREA_5'] > 100.0)]
